...
export const WaitingMode = t.brand(t.intersection([
  ...
  & string
  & 
  | 'WAIT', WaitingModeBrand> => true, 'WaitingMode')
...
export const TransferMode = t.brand(t.intersection([
  ...
  & 
  | 'LEG_SWITCH'
  | 'TRANSFER', TransferModeBrand> => true, 'TransferMode')
...
export const PersonalMode = t.brand(t.intersection([
  ...
  | 'SCOOTER'
  | 'SHARED_BICYCLE'
  | 'WALK', PersonalModeBrand> => true, 'PersonalMode')
...
export type PublicTransitMode = t.Branded<
  ...
  | 'TRAIN'
  | 'TRAM'
  | 'TRANSIT', PublicTransitModeBrand>
export const PublicTransitMode = t.brand(t.intersection([
  ...
  | 'TRAIN'
  | 'TRAM'
  | 'TRANSIT', PublicTransitModeBrand> => true, 'PublicTransitMode')
...
export type PrivateTransitMode = t.Branded<
  ...
  | 'SHARED_CAR'
  | 'TAXI'
  | 'TRAINISH', PrivateTransitModeBrand>
export const PrivateTransitMode = t.brand(t.intersection([
  ...
  | 'SHARED_CAR'
  | 'TAXI'
  | 'TRAINISH', PrivateTransitModeBrand> => true, 'PrivateTransitMode')
...
export type Default = t.Branded<
  ...
  | PersonalMode
  | PublicTransitMode
  | PrivateTransitMode, DefaultBrand>
export const Default = t.brand(t.union([
  WaitingMode,
  TransferMode,
  PersonalMode,
  PublicTransitMode,
  ...
  | PersonalMode
  | PublicTransitMode
  | PrivateTransitMode, DefaultBrand> => true, 'Default')
