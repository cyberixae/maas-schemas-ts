...
export const BookingState = t.brand(t.intersection([
  ...
  | 'REJECTED'
  | 'FINISHED'
  | 'UNKNOWN', BookingStateBrand> => true, 'BookingState')
...
export const LegState = t.brand(t.intersection([
  ...
  | 'ACTIVATED'
  | 'CANCELLED'
  | 'FINISHED', LegStateBrand> => true, 'LegState')
...
export const ItineraryState = t.brand(t.intersection([
  ...
  | 'CANCELLED'
  | 'CANCELLED_WITH_ERRORS'
  | 'FINISHED', ItineraryStateBrand> => true, 'ItineraryState')
