...
export const Currency = t.brand(
  t.string,
  (x): x is t.Branded<string, CurrencyBrand> => true,
  'Currency',
);
...
export const Time = t.brand(
  ...
  (x): x is t.Branded<number, TimeBrand> =>
    x >= 1451606400 && x <= 9007199254740991 && Number.isInteger(x),
  'Time',
);
...
export const Duration = t.brand(
  ...
  (x): x is t.Branded<number, DurationBrand> =>
    x >= -9007199254740991 && x <= 9007199254740991 && Number.isInteger(x),
  'Duration',
);
...
export const IsoDate = t.brand(
  t.string,
  (x): x is t.Branded<string, IsoDateBrand> => x.match(/^\d{4}-\d{2}-\d{2}/) !== null,
  'IsoDate',
);
