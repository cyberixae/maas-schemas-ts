...
export const DeviceToken = t.brand(t.string, (x): x is t.Branded<string, DeviceTokenBrand> => ( typeof x !== 'string' || x.match("^([A-Fa-f0-9]{2}){8,64}$") !== null ), 'DeviceToken')
...
export const PersonalName = t.brand(t.string, (x): x is t.Branded<string, PersonalNameBrand> => ( typeof x !== 'string' || x.match("^(?:\\p{L})+(?:[`'´\\-\\.,]?\\s?(?:\\p{L})*)*$") !== null ) && ( typeof x !== 'string' || x.length <= 255 ), 'PersonalName')
...
export const Phone = t.brand(t.string, (x): x is t.Branded<string, PhoneBrand> => ( typeof x !== 'string' || x.match("^\\+(?:\\d){6,14}\\d$") !== null ), 'Phone')
...
export const RawPhone = t.brand(t.string, (x): x is t.Branded<string, RawPhoneBrand> => ( typeof x !== 'string' || x.match("^\\+?(?:\\d){6,14}\\d$") !== null ), 'RawPhone')
...
export const Email = t.brand(t.string, (x): x is t.Branded<string, EmailBrand> => ( typeof x !== 'string' || x.match("^.+@.+\\..+$") !== null ) && ( typeof x !== 'string' || x.length <= 64 ), 'Email')
...
export const OpaqueId = t.brand(t.string, (x): x is t.Branded<string, OpaqueIdBrand> => ( typeof x !== 'string' || x.match("^[0-9abcdefABCDEF]+$") !== null ), 'OpaqueId')
...
export const ClientId = t.brand(t.intersection([
  ...
  & 
  | 'whim'
  | 'wechat', ClientIdBrand> => true, 'ClientId')
...
export const WhimDeepLink = t.brand(t.string, (x): x is t.Branded<string, WhimDeepLinkBrand> => ( typeof x !== 'string' || x.match("^(whim):\\/\\/\\/[^\\s/$.?#].[^\\s]*$") !== null ), 'WhimDeepLink')
