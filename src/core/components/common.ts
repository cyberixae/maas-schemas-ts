...
export const AgencyId = t.brand(
  t.string,
  (x): x is t.Branded<string, AgencyIdBrand> => x.length >= 2 && x.length <= 64,
  'AgencyId',
);
...
export const Signature = t.brand(
  t.string,
  (x): x is t.Branded<string, SignatureBrand> => x.length >= 1 && x.length <= 1024,
  'Signature',
);
...
export const JsonParam = t.brand(
  t.string,
  (x): x is t.Branded<string, JsonParamBrand> => x.length >= 2,
  'JsonParam',
);
...
export const PersonalName = t.brand(
  ...
  (x): x is t.Branded<string, PersonalNameBrand> =>
    x.match(/^(?:\p{L})+(?:[`'´\-\.,]?\s?(?:\p{L})*)*$/) !== null && x.length <= 255,
  'PersonalName',
);
...
export const Phone = t.brand(
  t.string,
  (x): x is t.Branded<string, PhoneBrand> => x.match(/^\+(?:\d){6,14}\d$/) !== null,
  'Phone',
);
...
export const RawPhone = t.brand(
  t.string,
  (x): x is t.Branded<string, RawPhoneBrand> => x.match(/^\+?(?:\d){6,14}\d$/) !== null,
  'RawPhone',
);
...
export const PaymentSourceId = t.brand(
  t.string,
  (x): x is t.Branded<string, PaymentSourceIdBrand> => x.length >= 3 && x.length <= 255,
  'PaymentSourceId',
);
...
export const AppInstanceId = t.brand(
  t.string,
  (x): x is t.Branded<string, AppInstanceIdBrand> => x.length >= 6,
  'AppInstanceId',
);
...
export const OpaqueId = t.brand(
  t.string,
  (x): x is t.Branded<string, OpaqueIdBrand> => x.match(/^[0-9abcdefABCDEF]+$/) !== null,
  'OpaqueId',
);
...
export const ClientId = t.brand(
  t.string,
  (x): x is t.Branded<string, ClientIdBrand> => true,
  'ClientId',
);
...
export const Ssid = t.brand(
  t.string,
  (x): x is t.Branded<string, SsidBrand> => x.length >= 4,
  'Ssid',
);
...
export const ErrorKey = t.brand(
  t.string,
  (x): x is t.Branded<string, ErrorKeyBrand> => x.length >= 1 && x.length <= 255,
  'ErrorKey',
);
