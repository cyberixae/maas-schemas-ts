...
export const AppInstanceId = t.brand(
  t.string,
  (x): x is t.Branded<string, AppInstanceIdBrand> => x === x && x.length >= 6,
  'AppInstanceId',
);
...
export const OpaqueId = t.brand(
  ...
  (x): x is t.Branded<string, OpaqueIdBrand> =>
    x === x && x.match(/^[0-9abcdefABCDEF]+$/) !== null,
  'OpaqueId',
);
...
export const ClientId = t.brand(
  t.string,
  (x): x is t.Branded<string, ClientIdBrand> => x === x,
  'ClientId',
);
...
export const Ssid = t.brand(
  t.string,
  (x): x is t.Branded<string, SsidBrand> => x === x && x.length >= 4,
  'Ssid',
);
interface SsidBrand {
