...
export const ComponentAddress = t.brand(t.string, (x): x is t.Branded<string, ComponentAddressBrand> => ( typeof x !== 'string' || x.match("^(?:(?:(?:country:(?:\\p{L}|[,\\.:\\-`'´\\s])+)|(?:state:(?:\\p{L}|[,\\.:\\-`'´\\s])+)|(?:city:(?:\\p{L}|[,\\.:\\-`'´\\s])+)|(?:zipCode:(?:\\d{3,10}|(?:\\p{L}|\\d){2,4}(\\s(?:\\p{L}|\\d){2,4})?))|(?:streetName:[^|]+)|(?:streetNumber:\\d+))\\|?){4,6}$") !== null ), 'ComponentAddress')
...
export const PlaceName = t.brand(t.string, (x): x is t.Branded<string, PlaceNameBrand> => ( typeof x !== 'string' || x.match("^(?:\\p{L}|\\d)(?:\\p{L}|\\d|[!-/:-@[-`{-\\xA9\\xAB-\\xB4\\xB6-\\xB9\\xBB-\\xBF\\xD7\\xF7])*(?:\\s(?:\\p{L}|\\d|[!-/:-@[-`{-\\xA9\\xAB-\\xB4\\xB6-\\xB9\\xBB-\\xBF\\xD7\\xF7])+)*$") !== null ) && ( typeof x !== 'string' || x.length <= 255 ), 'PlaceName')
...
export const Address = t.brand(t.string, (x): x is t.Branded<string, AddressBrand> => ( typeof x !== 'string' || x.match("^(?:(?:\\p{L}|\\d)+[`'´\\(\\)\\-/,\\.]?)+(\\s?(?:\\p{L}|[\\d`'´\\(\\)\\-/,\\.])?)*$") !== null ) && ( typeof x !== 'string' || x.length <= 255 ), 'Address')
...
export const CountryName = t.brand(t.string, (x): x is t.Branded<string, CountryNameBrand> => ( typeof x !== 'string' || x.match("^(?:\\p{L}|\\s)+$") !== null ) && ( typeof x !== 'string' || x.length <= 64 ), 'CountryName')
...
export const Country = t.brand(t.string, (x): x is t.Branded<string, CountryBrand> => ( typeof x !== 'string' || x.match("^[A-Z]{2,2}$") !== null ), 'Country')
...
export const City = t.brand(t.string, (x): x is t.Branded<string, CityBrand> => ( typeof x !== 'string' || x.match("^(?:\\p{L}|[\\s`'´])+$") !== null ) && ( typeof x !== 'string' || x.length <= 64 ), 'City')
